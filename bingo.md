...
Predictions for 2026. Some of these are things that I would LIKE to see happen
but don't really expect; others are things that I really hope won't happen, but
are sadly quite likely.
...
19. Gilmour Space has a successful launch from Queensland.
20. IPv6 adoption: IPv6 becomes available to 25% of home users worldwide.
31. Half Life 3 released. Not gonna happen but let's dream.
32. Vibe game: A 100% vibe-coded AAA game is released, but sales don't even cover the marketing budget.
33. Twitch breaks something and causes outages. Almost a non-event.
34. The Spiffing Brit proves that LLMs are perfectly balanced with no exploits.
35. The Unicode Consortium approves a set of new emoji, and the world largely ignores them.
46. Twitch adds support for APNG animated emotes
47. Twitch adds on-platform channel quotes (like clips but text)
48. A new Alice in Wonderland movie is released
49. A probe is sent to the moon, and lands sideways :(
50. Something originally animated gets a live-action remake, and it's actually good.
61. A critical zero-day exploit in Google Chrome causes major panic.
62. SpaceX Starship achieves orbit.
63. An indie game becomes the most-viewed Twitch category and not just on launch date.
64. A company markets 3D printed food to the very laziest of gamers.
65. Kitten Space Agency reaches $1M in total contributions
{:.gapnumbered}
...
<style>
.gapnumbered {
	list-style-type: gap-numbered;
}
@counter-style gap-numbered {
	symbols:
		'1' '2' '3' '4' '5'
		'16' '17' '18' '19' '20'
		'31' '32' 'FREE' '34' '35'
